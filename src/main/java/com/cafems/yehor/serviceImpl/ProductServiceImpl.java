...
import com.cafems.yehor.dao.ProductDao;
import com.cafems.yehor.service.ProductService;
        ...
        try {
            if(jwtFilter.isAdmin()){
                if(validateProductMap(requestMap, true)){
                    Optional<Product> opt = productDao.findById(Integer.parseInt(requestMap.get("id")));
                    if(opt.isPresent()){
